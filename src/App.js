      ...
      <div style={{ backgroundColor: "#000", color: "white" }}>
        ...
        <Space direction="vertical">
          ...
          <Text style={{ color: "white" }}>
            description: sfhsfsfs sfjskfsdkjsdd sfhskjhdkg skfjs jfkshw sfhsk
            hskj sfdjsdglhglsdgdsdlfgsk jdskdjskjghsdkjghdskjsdg
            sfjsdgkjsdhkjsdhkdjsdh
          </Text>
        </Space>
        <Row>
          <Col span={10}>
            <Button style={{ width: "95%", marginLeft: "4px" }} type="primary">
              Follow
            </Button>
          </Col>
          <Col span={10}>
            <Button style={{ width: "95%", margin: "0 4px" }}>Message</Button>
          </Col>
          <Col span={4}>
